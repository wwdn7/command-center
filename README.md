...
Please read the following intruction below to start. 
...
### Installation
1. Clone the repository: `git clone https://ProVisionCamera@gitlab.com/ProVisionCamera/desktop-command-center.git`
